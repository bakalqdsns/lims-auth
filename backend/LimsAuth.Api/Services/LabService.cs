...
{
    Task<List<LabDto>> GetListAsync(string? keyword = null, string? departmentId = null, string? labType = null);
...
public class LabService : ILabService
{
    ...
    public async Task<List<LabDto>> GetListAsync(string? keyword = null, string? departmentId = null, string? labType = null)
    {
